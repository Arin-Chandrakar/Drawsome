/*
  ...
  - You are about to drop the column `slut` on the `Room` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Room_slut_key";

-- AlterTable
ALTER TABLE "Room" DROP COLUMN "slut",
